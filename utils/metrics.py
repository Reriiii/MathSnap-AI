...
def strip_open_braces(token_list: list) -> list:
    """Remove all '{' tokens from a sequence.

    Used to normalize GT sequences for evaluation: the model outputs imaginary
    '}' instead of explicit '{...}' grouping, so '{' must be stripped from GT
    before computing edit-distance / ExpRate.
    """
